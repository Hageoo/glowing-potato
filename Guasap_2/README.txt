# README for Treehouse Talks - Streamlit Chat Application
...
2. **Streamlit:** Install Streamlit, a web application framework, using `pip`:

   ```bash
   pip install streamlit
   ```

3. **MongoDB:** You need a running MongoDB server for data storage. Make sure you have MongoDB installed and running.

4. **Streamlit Auto Refresh:** Install the `streamlit-autorefresh` library for automatic page refresh:
