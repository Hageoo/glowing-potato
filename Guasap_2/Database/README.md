# Mondongo Authentication and Messaging System
...
You need a running MongoDB server where the data will be stored. Make sure you have MongoDB installed and running.

### 3. Required Python Libraries: 

You'll need the following Python libraries installed. You can install them using `pip` if you haven't already:
